...
# df_data_host_community_reproject = df_data_host_community.to_crs(df_data_test.crs)
...
# write output
# df_selection_test.to_crs(df_data_host_community.crs).to_file("outputs/test_buildings_ref_host.gpkg", layer='test_buildings_ref_host', driver="GPKG")
df_selection_19d.to_crs(df_data_host_community.crs).to_file("outputs/19d_buildings_ref_host.gpkg", layer='19d_buildings_ref_host', driver="GPKG")
df_selection_177.to_crs(df_data_host_community.crs).to_file("outputs/177_buildings_ref_host.gpkg", layer='177_buildings_ref_host', driver="GPKG")
